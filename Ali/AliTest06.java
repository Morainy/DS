...
public class AliTest06  {
	public static void main(String[] args) throws Exception{
		...
		float [][] scoreArray = new float [884][9531];   //打分矩阵
	...
	int sumCountArray=0;
	for(int i=0;i<top_k.countArray.length;i++){
		sumCountArray+=top_k.countArray[i];
	}
	System.out.println("sumCountArray="+sumCountArray);
	rdf1.close();
	rdf2.close();
	rdf3.close();
	rdf4.close();
